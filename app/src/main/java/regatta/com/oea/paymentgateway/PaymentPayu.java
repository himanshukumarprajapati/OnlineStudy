package regatta.com.oea.paymentgateway;
...
public class PaymentPayu extends Activity {
    ...
    TextView textView_productName;TextView textView_productPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_productPrice = (TextView)findViewById(R.id.sluggggggg);
        textView_productName= (TextView) findViewById(R.id.slug);
        ...
        textView_productPrice.setText(getIntent().getExtras().getString("int_value"));
         textView_productName.setText(getIntent().getExtras().getString("subject_name"));
    ...
    public void navigateToBaseActivity(View view) {
        ...
        String bookname=textView_productPrice.getText().toString();
        String amount = textView_productPrice.getText().toString();
       // mPaymentParams.setAmount(amount);
        String email = "him@gmail.com";
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PaymentPayu.this);
