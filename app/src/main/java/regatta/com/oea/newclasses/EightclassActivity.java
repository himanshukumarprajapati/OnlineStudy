...
public class EightclassActivity extends AppCompatActivity {
    //Web api url
    //public static final String DATA_URL = "http://www.simplifiedcodingreaders.16mb.com/superheroes.php";
    public static final String DATA_URL="http://oea.org.in/oeaadmin/api/index.php?access=true&action=view_subject_by_class_id&class_id=4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EightclassActivity.this, regatta.com.oea.MainActivity.class);
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        ...
                        if (position==0){
                          ...
                          /*  Intent intent= new Intent(MainActivity.this, SubjectActivity.class);
                            startActivity(intent);
                            finish();*/
                            Intent intent = new Intent(EightclassActivity.this, SubjectActivity.class);
                          ...
                          /*  Intent intent= new Intent(MainActivity.this, SubjectActivity.class);
                            ...
                            Intent intent= new Intent(EightclassActivity.this, SubjectsevenActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        else if (position==8){
