...
public class SubjectActivity extends AppCompatActivity {
   ...
   // public static final String DATA_URL="http://oea.org.in/oeaadmin/api/index.php?access=true&action=get_books_list_by_class_and_subject_id&subject_id="+ AppConstantVariables.idforuse+"&class_id=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bookgrid);
        gridView = (GridView) findViewById(R.id.gridView);
        Log.d("aal",""+AppConstantVariables.idforuse);
    ...
    private void getData(){
        final String DATA_URL="http://oea.org.in/oeaadmin/api/index.php?access=true&action=get_books_list_by_class_and_subject_id&subject_id="+ AppConstantVariables.idforuse+"&class_id="+AppConstantVariables.idclass;
              ...
              /*  FeedItem item = new FeedItem();
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        ...
                        if (position>=0){
                          //  Intent intent= new Intent(SubjectActivity.this, regatta.com.oea.adapter.MainActivity.class);
                            Intent intent= new Intent(SubjectActivity.this, regatta.com.oea.adapter.MainActivity.class);
                            ...
                            Toast.makeText(SubjectActivity.this,"Wrong Selection",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
