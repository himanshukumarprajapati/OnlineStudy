...
public class SubjectsevenActivity extends AppCompatActivity {
    //Web api url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SubjectsevenActivity.this,MainActivity.class);
              ...
              /*  FeedItem item = new FeedItem();
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        ...
                        if (position==0){
                            Intent intent= new Intent(SubjectsevenActivity.this, regatta.com.oea.adapter.MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        else {
                            Toast.makeText(SubjectsevenActivity.this,"Wrong Selection",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
