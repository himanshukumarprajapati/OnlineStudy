...
import regatta.com.oea.paymentgateway.PaymentPayu;

public class MainActivity extends AppCompatActivity {
    //Web api url
    //public static final String DATA_URL = "http://www.simplifiedcodingreaders.16mb.com/superheroes.php";
   // public static final String DATA_URL="http://oea.org.in/oeaadmin/api/index.php?access=true&action=view_subject_by_class_id&class_id="+AppConstantVariables.idclass;
                       ...
                       // Toast.makeText(MainActivity.this, "" + position, Toast.LENGTH_SHORT).show();
                        if (position==0){
                           ...
                           // position.
                            ...
                            String b= String.valueOf(names.indexOf(String.valueOf(position)));

                            String bbb=names.get(position);
                            Log.d("a",""+a);
                          ...
                          /*  Intent intent= new Intent(MainActivity.this, SubjectActivity.class);
                            startActivity(intent);
                            finish();*/
                            Intent intent = new Intent(MainActivity.this, PaymentPayu.class);
                            intent.putExtra("int_value", aaa);
                            intent.putExtra("subject_name",bbb);
                            startActivity(intent);
                        }
                        else if (position==1){
                            Log.d("subjectid",""+subid);
