...
public class SubjectsixActivity extends AppCompatActivity {
    //Web api url
    //public static final String DATA_URL = "http://www.simplifiedcodingreaders.16mb.com/superheroes.php";
    public static final String DATA_URL="http://oea.org.in/oeaadmin/api/index.php?access=true&action=get_books_list_by_class_and_subject_id&subject_id=108&class_id=3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SubjectsixActivity.this,MainActivity.class);
              ...
              /*  FeedItem item = new FeedItem();
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        ...
                        if (position==0){
                            Intent intent= new Intent(SubjectsixActivity.this, regatta.com.oea.adapter.MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        else {
                            Toast.makeText(SubjectsixActivity.this,"Wrong Selection",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
