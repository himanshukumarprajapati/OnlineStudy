...
public class TwelveclassActivity extends AppCompatActivity {
    ...
    public static final String DATA_URL="http://oea.org.in/oeaadmin/api/index.php?access=true&action=view_subject_by_class_id&class_id=7";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TwelveclassActivity.this, regatta.com.oea.MainActivity.class);
              ...
              /*  FeedItem item = new FeedItem();
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                        ...
                        if (position==0){
                            Intent intent= new Intent(TwelveclassActivity.this, SubjectActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        else {
                            Toast.makeText(TwelveclassActivity.this,"Wrong Selection",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
