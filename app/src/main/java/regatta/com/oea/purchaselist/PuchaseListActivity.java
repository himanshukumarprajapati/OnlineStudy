package regatta.com.oea.purchaselist;
 ...
 */
public class PuchaseListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context= PuchaseListActivity.this;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  if(!old.getText().toString().equalsIgnoreCase("abc")){
                   ...
                   checkLogin();
                    Toast.makeText(PuchaseListActivity.this, "Your password has been changed", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(PuchaseListActivity.this, LoginActivity.class);
                    startActivity(intent);
                }
                else if(!newpassword.getText().toString().equals(confirmpassword.getText().toString()))
                {
                    Toast.makeText(PuchaseListActivity.this, "Confirm Your Password Or Set New Password", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(PuchaseListActivity.this,"Try Strong Password Minimum of 6 Characters",Toast.LENGTH_LONG).show();
                }
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PuchaseListActivity.this,MainActivity.class);
                startActivity(intent);
            }
        });
    }
   /* public class SendDataToServer extends AsyncTask<String,String,String> {
        ProgressDialog progressDialog= new ProgressDialog (PuchaseListActivity.this);
